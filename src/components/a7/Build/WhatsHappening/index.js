            ...
            <table style={{marginBottom: '16px'}}>
                <tr>
                    ...
                    <td style={{width: '100%'}}>
                        ...
                        <hr/>
                        <span>
                            <a href="home.html"><i className="far fa-image me-3"/></a>
                            <a href="home.html"><i
                                className="far fa-analytics me-3"/></a>
                            <a href="home.html"><i className="far fa-smile me-3"/></a>
                            <a href="home.html"><i
                                className="far fa-calendar me-3"/></a>
                        </span>
